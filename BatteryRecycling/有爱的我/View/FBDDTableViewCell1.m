...
#import "FBDDTableViewCell1.h"

@implementation FBDDTableViewCell1
...
- (void)configCell:(id)model
{
    ...
    [_HHSNameLabel setText:model[@"reclaimerName"]];
    [_addressLabel setText:model[@"reclaimerArea"]];
}
