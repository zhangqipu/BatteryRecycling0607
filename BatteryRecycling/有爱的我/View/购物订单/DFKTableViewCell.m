...
@implementation DFKTableViewCell
...
- (void)configCell:(id)model
{
    ...
    [_countLabel setText:[NSString stringWithFormat:@"共%@件", [model[@"totalQty"] stringValue]]];
    ...
    [_amountLabel setText:[NSString stringWithFormat:@"实付款: %@元", [model[@"totalAmount"] stringValue]]];
}
